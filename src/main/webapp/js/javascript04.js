...
//	함수의 인수가 1개면 ()를 생략할 수 있다. 0이나 2개면 안됨
...
const add2 = (a, b) => { // 인수가 두개라 () 생략못함
	return a + b;
}
console.log(add2(14, 8));

const add3 = (a, b) => a + b; // 인수가 두개라 () 생략못함
console.log(add3(14, 8));
console.log('==========================================');
...
//hello(); // 에러, 자동실행 함수는 일반 함수처럼 실행하면 에러가 발생한다.
