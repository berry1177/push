...
//	Object.values(): 인수로 지정된 객체의 key에 핟랑된 value 값을 배열로 묶어서 얻어온다.
const values = Object.values(doggy);
console.log('Object.values(doggy): ' + values);

for (let i=0; i<values.length; i++) { // 일반 for, var let 은 가능 const는 안된다
...
//	Object.entries(): 인수로 지정된 객체의 key와 value 값을 배열로 묶어서 얻어온다.
