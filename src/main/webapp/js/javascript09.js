...
//	splice() 함수가 실행되서 추출되는 데이터는 원본에서 제거된다.
...
//	slice(a, b): 배열에서 a번째 index부터 b - 1번째 index 까지 추출해 배열로 리턴한다.
...
//	concat(): concat() 함수가 실행된 배열에 인수로 지정된 배열을 연결해서 리턴한다.
